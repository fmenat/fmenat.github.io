...
header:
    teaser: paper4.png
---
* Paper url: [DOI: 10.1016/j.neucom.2025.130175](https://doi.org/10.1016/j.neucom.2025.130175)
* Paper code: [github.com/fmenat/CoM-views](https://github.com/fmenat/CoM-views)

![missing data](/images/paper4.png)
