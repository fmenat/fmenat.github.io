...
excerpt: 'Label Noise, Machine Learning, Latent variable.'
date: 2019-10-22
venue: 'Iberoamerican Congress on Pattern Recognition (CIARP)'
slidesurl: 'https://fmenat.github.io/files/conf3_slides.pdf'
citation: 'Mena, Francisco, and Ricardo Ñanculef. Revisiting Machine Learning from Crowds a Mixture Model for Grouping Annotations. Iberoamerican Congress on Pattern Recognition. Cham: Springer International Publishing, 2019.'
header:
    teaser: conf3.png
---
* Paper url: [DOI: 10.1007/978-3-030-33904-3_46](https://doi.org/10.1007/978-3-030-33904-3_46)
* Paper code: [github.com/fmenat/MixtureofGroups](https://github.com/fmenat/MixtureofGroups)

![missing data](/images/conf3.png)
