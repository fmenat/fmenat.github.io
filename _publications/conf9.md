...
permalink: /publication/conf9
excerpt: 'Crop yield prediction, Dataset, Remote sensing.'
date: 2026-04-01
venue: 'IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR)'
citation: 'Miranda, Miro, et al. "Yieldsat: A multimodal benchmark dataset for high-resolution crop yield prediction." arXiv preprint arXiv:2604.00940 (2026).'
header:
    teaser: conf9.jpg
---
* Paper url: [DOI: CVPR website](https://openaccess.thecvf.com/content/CVPR2026/html/Miranda_YieldSAT_A_Multimodal_Benchmark_Dataset_for_High-Resolution_Crop_Yield_Prediction_CVPR_2026_paper.html)
* Project website: [https://yieldsat.github.io/](https://yieldsat.github.io/)

![missing data](/images/conf9.png)
