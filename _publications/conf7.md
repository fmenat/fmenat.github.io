...
paperurl: 'https://fmenat.github.io/files/conf7.pdf'
slidesurl: 'https://fmenat.github.io/files/conf7_slides.pdf'
citation: 'Mena, Francisco, et al. "On what depends the robustness of multi-source models to missing data in Earth observation?." IGARSS 2025-2025 IEEE International Geoscience and Remote Sensing Symposium. IEEE, 2025.'
header:
    teaser: conf7.png
---
* Paper url: [DOI: 10.1109/IGARSS55030.2025.11242446](https://doi.org/10.1109/IGARSS55030.2025.11242446)

![missing data](/images/conf7.png)
